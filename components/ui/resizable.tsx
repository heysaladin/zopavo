...
const ResizableHandle = ({
  ...
  <ResizablePrimitive.Separator
    className={cn(
      // Note: the separator's aria-orientation is the inverse of the group's
      // orientation (a horizontal group has vertical separators).
      ...
      "aria-[orientation=horizontal]:h-px aria-[orientation=horizontal]:after:absolute aria-[orientation=horizontal]:after:inset-x-0 aria-[orientation=horizontal]:after:top-1/2 aria-[orientation=horizontal]:after:h-1 aria-[orientation=horizontal]:after:-translate-y-1/2 aria-[orientation=horizontal]:[&>div]:rotate-90",
      className
    )}
    {...props}
  >
